...
def download_youtube_audio(url: str) -> str:
    ...
    ydl_opts = {
        ...
        "quiet": True,
        # NOTE: YouTube aggressively rate-limits / blocks datacenter IPs
        # (which is what cloud hosts like Streamlit Cloud use), so this
        # alone will not eliminate 403 errors there — see README for
        # alternatives (cookies file, running locally, etc.).
        "extractor_args": {
